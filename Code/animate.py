# -*- coding: utf-8 -*-
"""
Created on Tue Dec 25 07:21:37 2018
...
#ymin2 = max(0, round(min(main_file['x'])-10, -1))
#ymax2 = min(120, round(max(main_file['x'])+10, -1))
...
#df_hash = df_hash.loc[(df_hash['y'] < ymax2) & (df_hash['y'] > ymin2), ]
